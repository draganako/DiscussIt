...
namespace MongoDB_Repository.Layouts
{
    public partial class PageLayout1 : UserControl
    {
        ...
        public PageLayout1(User current)
        {
            InitializeComponent();
        ...
        public PageLayout1(User current, User displayedUsr)
        {
            InitializeComponent();
        ...
        {
            lblUsername.Text = "User: " + displayedUser.username + ", " + displayedUser.CalculateRank();
        ...
        private void PageLayout1_Load(object sender, EventArgs e)
        {
